...
map("n", "<leader>te", ":tabedit<Return>", { desc = "new tab buffer", noremap = true, nowait = true, silent = true })
map("n", "<leader>tn", ":tabNext<Return>", { desc = "next tab buffer", noremap = true, nowait = true, silent = true })
map("n", "<leader>tp", ":tabprev<Return>", { desc = "prev tab buffer", noremap = true, nowait = true, silent = true })
